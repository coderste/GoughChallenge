<?php
/**
 * Class Name: Bootstrap Mega Menu
 * Version: 1.0
 * Author: E4K Development
 */
class Bootstrap_MegaMenu extends Walker_Nav_Menu {
    ...
    {
        $output .= ( $depth == 0 ) ? '<ul class="dropdown-menu">' . '<div class="row">' : '<ul class="child-list">';
    }
    ...
    function display_element( $element, &$children_elements, $max_depth, $depth = 0, $args, &$output )
    {
        ...
        if ( $element && ( $depth === 1 ) )
        {
            $element->classes[] = 'col-md-3 col-sm-12 menu-col';
        }
...
function Bootstrap_MegaMenu_Fallback()
{
